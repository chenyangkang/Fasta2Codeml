...
parser.add_argument('--foreground_file',help='text format foreground species list, with names corresponding to the headers in the fasta sequence file. Should contain NO space anywhere.')
